package com.example.tag_backend.utils;
...
public class RedisUtils {
    ...
    public boolean hset(String key, String item, Object value) {
        try {
            ...
            log.error("HashSet失败，key: {}, item: {}", key, item, e);
            return false;
        }
    }
