...
# 任务4完整标注报告HTML转PDF脚本（50张图片）

echo "=========================================="
echo "📄 任务4完整标注报告 - HTML转PDF"
echo "=========================================="
echo ""

# 文件路径
INPUT_HTML="完整标注报告_20251029_184930.html"
OUTPUT_PDF="任务4_完整标注报告_50张.pdf"
...
echo ""
echo "🚀 开始转换..."
echo "⏳ 由于文件较大（49MB），转换可能需要1-2分钟，请耐心等待..."
echo ""
